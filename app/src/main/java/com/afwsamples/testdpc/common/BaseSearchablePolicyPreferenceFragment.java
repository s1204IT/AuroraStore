...
/**
 * Base class of searchable policy preference fragment. With specified preference key, it will
 * scroll to the corresponding preference and highlight it.
 */
...
public abstract class BaseSearchablePolicyPreferenceFragment extends PreferenceFragment
  ...
  public final void dump(
      String prefix, PrintWriter pw, FileDescriptor fd, boolean quietModeOnly, String[] args) {
    // Dump its own state
    if (mAdapter == null) {
