...
public abstract class BaseStringItemsFragment extends BaseManageComponentFragment<Void>
  ...
  public BaseStringItemsFragment(int fragmentTitleResId, int dialogTitleResId, int emptyItemResId) {
  ...
  protected BaseAdapter createListAdapter() {
    mItemArrayAdapter = new ItemEntryArrayAdapter(getActivity(), mItems, this);
