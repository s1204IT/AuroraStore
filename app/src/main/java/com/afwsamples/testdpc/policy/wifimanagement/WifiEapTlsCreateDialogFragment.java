...
/**
 * Dialog for adding/editing EAP-TLS Wifi. We currently only support CA cert in x.509 format and
 * client cert in PKCS12 format.
 */
  ...
  private void onSelectClientCertClicked(View view) {
    KeyChain.choosePrivateKeyAlias(
        ...
        alias -> {
          ...
          getActivity()
              .runOnUiThread(() -> updateSelectedCert(mUserCertTextView, /* uri= */ null, alias));
        }, /* keyTypes[] */
        null, /* issuers[] */
        null, /* uri */
        null, /* alias */
