...
public class AppPermissionsArrayAdapter
  ...
  public AppPermissionsArrayAdapter(
      Context context, int resource, List<AppPermission> objects, ComponentName admin) {
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null || !(convertView.getTag() instanceof AppPermissionsViewHolder)) {
      convertView =
          LayoutInflater.from(getContext()).inflate(R.layout.permission_row, parent, false);

      viewHolder = new AppPermissionsViewHolder();
      viewHolder.permissionName = (TextView) convertView.findViewById(R.id.permission_name);
      viewHolder.permissionGroup = (RadioGroup) convertView.findViewById(R.id.permission_group);
